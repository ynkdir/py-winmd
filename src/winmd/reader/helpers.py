...
def get_type_namespace_and_name(index: coded_index) -> tuple[str, str]:
    ...
    if found is None:
        ...
        row: TypeDef | TypeRef = index.get_row(table)
