"""Dumps Win32 API signatures from the Win32 metadata (Windows.Win32.winmd).
    ...
    python examples/win32.py --list
    python examples/win32.py --namespace Windows.Win32.UI.WindowsAndMessaging
    python examples/win32.py --search CreateWindow
    python examples/win32.py --search MSG --kind struct
